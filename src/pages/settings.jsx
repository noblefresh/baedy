...
import { fetchBank } from '@/services/authService';
            ...
            <div className="">
              {
                bankList.length > 0 ? (
                  <div className="space-y-3">
                    <div className="text-xs inline-block px-12 text-center cursor-pointer disabled:cursor-none disabled:bg-amber-500/35 shadow-md bg-amber-500 text-white rounded-lg py-3">Add Account</div>
